...
def generate_report(results):
    ...
    lines.append(f"Discourse relations: {total_discourse} (avg {total_discourse / len(results):.1f}/turn)")
    lines.append(f"SRL frames: {total_frames} (avg {total_frames / len(results):.1f}/turn)")
