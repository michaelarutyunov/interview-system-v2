...
|------|-------------|---------------|------------------|
| Full | Reaches emotional_job / social_job | 8 | 3 |
...
### Chain 1 [surface]
**Path**: `sitting at desk for hours` (job_context, t=?) → `water is too boring during long desk sessions` (pain_point, t=?) → `grab Diet Coke in the afternoon` (solution_approach, t=1) → `fizzy drink makes break feel like a real break` (gain_point, t=1) → `carbonation is a mental ritual, not just physical hydration` (emotional_job, t=3) → `carbonation feels more satisfying than plain water` (gain_point, t=3) → `fizzy drink feels like a treat during errands` (gain_point, t=3) → `treat oneself during routine or tedious tasks` (emotional_job, t=3)
...
- `grab Diet Coke in the afternoon → fizzy drink makes break feel like a real break` [enables] (t=1): _"(no quote)"_
...
- `carbonation is a mental ritual, not just physical hydration → carbonation feels more satisfying than plain water` [supports] (t=3): _"(no quote)"_
- `carbonation feels more satisfying than plain water → fizzy drink feels like a treat during errands` [enables] (t=3): _"(no quote)"_
- `fizzy drink feels like a treat during errands → treat oneself during routine or tedious tasks` [supports] (t=3): _"(no quote)"_
### Chain 2 [surface]
**Path**: `sitting at desk for hours` (job_context, t=?) → `water is too boring during long desk sessions` (pain_point, t=?) → `grab Diet Coke in the afternoon` (solution_approach, t=1) → `fizzy drink makes break feel like a real break` (gain_point, t=1) → `carbonation is a mental ritual, not just physical hydration` (emotional_job, t=3) → `carbonation feels more satisfying than plain water` (gain_point, t=4) → `ZeroFizz feels like a treat despite being zero sugar` (gain_point, t=4) → `feel like the evening is a treat or indulgence` (emotional_job, t=4)
...
- `fizzy drink makes break feel like a real break → carbonation is a mental ritual, not just physical hydration` [supports] (t=1): _"(no quote)"_
- `carbonation is a mental ritual, not just physical hydration → carbonation feels more satisfying than plain water` [supports] (t=3): _"(no quote)"_
- `carbonation feels more satisfying than plain water → ZeroFizz feels like a treat despite being zero sugar` [supports] (t=4): _"(no quote)"_
...
### Chain 3 [surface]
**Path**: `sitting at desk for hours` (job_context, t=?) → `water is too boring during long desk sessions` (pain_point, t=?) → `grab Diet Coke in the afternoon` (solution_approach, t=1) → `fizzy drink makes break feel like a real break` (gain_point, t=1) → `carbonation is a mental ritual, not just physical hydration` (emotional_job, t=1) → `feel mentally engaged while working` (gain_point, t=1)
...
- `grab Diet Coke in the afternoon → fizzy drink makes break feel like a real break` [enables] (t=1): _"(no quote)"_
- `fizzy drink makes break feel like a real break → carbonation is a mental ritual, not just physical hydration` [supports] (t=1): _"(no quote)"_
- `carbonation is a mental ritual, not just physical hydration → feel mentally engaged while working` [enables] (t=1): _"(no quote)"_
### Chain 4 [surface]
**Path**: `having already consumed several regular sodas that day` (job_trigger, t=8) → `cut back on sugar without giving up fizzy drinks` (job_statement, t=8) → `carbonation feels more satisfying than plain water` (gain_point, t=3) → `fizzy drink feels like a treat during errands` (gain_point, t=3) → `treat oneself during routine or tedious tasks` (emotional_job, t=3)
...
- `cut back on sugar without giving up fizzy drinks → carbonation feels more satisfying than plain water` [supports] (t=8): _"(no quote)"_
- `carbonation feels more satisfying than plain water → fizzy drink feels like a treat during errands` [enables] (t=3): _"(no quote)"_
- `fizzy drink feels like a treat during errands → treat oneself during routine or tedious tasks` [supports] (t=3): _"(no quote)"_
### Chain 5 [surface]
**Path**: `having already consumed several regular sodas that day` (job_trigger, t=8) → `cut back on sugar without giving up fizzy drinks` (job_statement, t=8) → `carbonation feels more satisfying than plain water` (gain_point, t=4) → `ZeroFizz feels like a treat despite being zero sugar` (gain_point, t=4) → `feel like the evening is a treat or indulgence` (emotional_job, t=4)
...
- `ZeroFizz feels like a treat despite being zero sugar → feel like the evening is a treat or indulgence` [enables] (t=4): _"(no quote)"_
### Chain 6 [surface]
**Path**: `selectively disclosing sugar-free content based on audience interest` (solution_approach, t=7) → `subtle branding that doesn't signal sugar-free to others` (gain_point, t=6) → `fit in socially without drawing attention to health-conscious choices` (emotional_job, t=6)

**Evidence**:
- `selectively disclosing sugar-free content based on audience interest → subtle branding that doesn't signal sugar-free to others` [supports] (t=7): _"(no quote)"_
...
### Chain 7 [surface]
**Path**: `at someone else's place where ZeroFizz is already stocked` (job_context, t=8) → `avoid the social awkwardness of requesting a different drink` (social_job, t=8) → `fit in socially without drawing attention to health-conscious choices` (emotional_job, t=8)

**Evidence**:
- `at someone else's place where ZeroFizz is already stocked → avoid the social awkwardness of requesting a different drink` [enables] (t=8): _"(no quote)"_
- `avoid the social awkwardness of requesting a different drink → fit in socially without drawing attention to health-conscious choices` [supports] (t=8): _"(no quote)"_
### Chain 8 [surface]
...
### Chain 1 [canonical]
**Path**: `social_consumption_set` (job_context, t=?) → `diet_stigma_avoidance` (social_job, t=?) → `inconspicuous_wellness` (emotional_job, t=?)

**Evidence**:
- `social_consumption_set → diet_stigma_avoidance` [enables] (t=?): _"(no quote)"_
- `diet_stigma_avoidance → inconspicuous_wellness` [supports] (t=?): _"(no quote)"_
### Chain 2 [canonical]
...
### Chain 6 [surface]
**Path**: `wanting something cold and refreshing` (job_trigger, t=2) → `feel refreshed and stimulated` (gain_point, t=2)

**Evidence**:
- `wanting something cold and refreshing → feel refreshed and stimulated` [supports] (t=2): _"(no quote)"_
### Chain 7 [surface]
